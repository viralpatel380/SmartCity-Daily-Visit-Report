...
for(var key in v)
{
	...
	"<h3 style='color:red;text-align:center;'>"+"Host Info"+"</h3>"+
 	" <h5 style='color:red;text-align:center;' class='card-title is-primary' >"+"Aadhar Number:&nbsp "+v[key] .adhar+"</h5>"+
 	" <h6 style='color:red;text-align:center;' class='card-subtitle mb-2 text-muted'>"+"Name: &nbsp" +v[key].name+"</h6>"+
	 " <h6 style='color:red;text-align:center;' class='card-subtitle mb-2 text-muted'>"+"Location: &nbsp" +v[key].pincode+"</h6>"+
